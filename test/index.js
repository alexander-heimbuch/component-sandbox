...
const { removeSync, mkdirpSync, readFileSync, outputFileSync } = require('fs-extra');
...
outputFileSync(path.resolve(TMP_FOLDER, 'index.html'), testbed({ scripts: TEST_FILES }), 'utf-8');
